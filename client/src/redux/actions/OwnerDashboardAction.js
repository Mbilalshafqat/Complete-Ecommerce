...
export const OwnerAllProductsGetFunc = () => async (dispatch) => {
  try {
    ...
    const res = await fetch(`${server}/product/getOwnerProducts`, {
      method: "GET",
      headers: {
...
export const OwnerAllEvenstGetFunc = () => async (dispatch) => {
  try {
    ...
    const res = await fetch(`${server}/event/getOwnerEvents`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        token: localStorage.getItem("shopownerToken"),
...
export const deleteproductbyOwnerredux =
  (id, navigate, setSelect) => async (dispatch) => {
    try {
      ...
      const res = await fetch(`${server}/product/deleteproductbyOwner/${id}`, {
        method: "delete",
        headers: {
          "Content-Type": "application/json",
          token: localStorage.getItem("shopownerToken"),
...
export const CreateEventProduct =
  ...
  async (dispatch) => {
    try {
      ...
      const res = await fetch(`${server}/event/createEventProduct`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          token: localStorage.getItem("shopownerToken"),
...
export const deleteEventbyOwner = (id) => async (dispatch) => {
  try {
    ...
    const res = await fetch(`${server}/event/deleteeventbyOwner/${id}`, {
      method: "delete",
      headers: {
        "Content-Type": "application/json",
        token: localStorage.getItem("shopownerToken"),
...
export const AllProductsfun = () => async (dispatch) => {
  try {
    ...
    const res = await fetch(`${server}/product/allProducts`, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
      },
...
export const getAllEvents = () => async (dispatch) => {
  try {
    ...
    const res = await fetch(`${server}/event/getAllEvents`, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
      },
...
export const getSingleProduct = (id) => async (dispatch) => {
  try {
    ...
    const res = await fetch(`${server}/product/singleProduct/${id}`, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
      },
...
export const getSingleEvent = (id) => async (dispatch) => {
  try {
    dispatch({ type: "getSingleProductDataLoad" });
    const res = await fetch(`${server}/event/singleEvent/${id}`, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
      },
...
export const createReview = (comment, id) => async (dispatch) => {
  try {
    ...
    const res = await fetch(`${server}/product/addreview`, {
      method: "put",
      headers: {
        "Content-Type": "application/json",
